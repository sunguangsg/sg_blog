...
<head>
    ...
    <!-- Font-Awesome -->
    <link rel="stylesheet" href="/static/blogs/css/font-awesome/css/font-awesome.min.css">

    <!-- Google Webfonts -->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600|PT+Serif:400,400italic' rel='stylesheet' type='text/css'>

    <!-- Styles -->
    <link rel="stylesheet" href="/static/blogs/css/style.css" id="theme-styles">
...
<body>
    ...
    <script src="/static/js/blog/bootstrap.min.js"></script>
