    ...
    MyDropLoad.prototype.init = function(options){
        ...
        me.opts = $.extend(true, {}, {
            ...
            domDown : {                                                          // 下方DOM
               ...
               /* domRefresh : '<div class="dropload-refresh">暂无数据</div>',*/
                domLoad    : '<div class="dropload-load"><span class="loading"></span>加载中...</div>',
...
$(document).ready(function(){
        $(".hover:even").css('background','#EAEAE8')//奇数行
        .mouseover(function(){
            $(this).css('background','#E0E0D6')//当鼠标移上变色
        })
        .mouseout(function(){
            $(this).css('background','#EAEAE8')//移出变会原来颜色
        });
        $('.hover:odd').css('background','#EDEDE3')//偶数行
        .mouseover(function(){
            $(this).css('background','#E0E0D6')//移出变会颜色
        })
        .mouseout(function(){
            $(this).css('background','#EDEDE3')//移出变会原来颜色
        });
